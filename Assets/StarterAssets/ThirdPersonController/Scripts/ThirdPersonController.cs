...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private System.Collections.IEnumerator PerformExplosion()
        {
            canExplode = false;
            ...
            // Apply physical explosion force
            ...
            foreach (var hit in colliders)
            {
                ...
                if (rb != null)
                {
                    rb.AddExplosionForce(explosionForce, pos, explosionRadius, upwardsModifier, explosionForceMode);
                }
            }
